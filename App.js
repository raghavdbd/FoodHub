...
<a href="/">
<div id="logo">
            <img src="https://www.purleyfoodhub.net/wp-content/uploads/2020/11/original-logo.png" alt="logo" />
      </div>
...
const RestaurentCard=({
    ...
    return (
        ...
        <div className="card" >
         <img src={"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/" + cloudinaryImageId} alt="" />
         <h2>{name}</h2>
         <h3>{cuisines.join(",")}</h3>
